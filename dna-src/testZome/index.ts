...
function genesis(){
  ...
  const holovolt_hash=JSON.parse(call("happs", "createApp", {appParam:{uuid:"1234-612-161343",title:"HoloVolt",author:{Hash:App.Agent.Hash,Name:"Phlip"},description:"A Holochain Version of the your ID Volt",thumbnail:"/imp4.jpg"}}));
  const netflix_hash=JSON.parse(call("happs", "createApp", {appParam:{uuid:"1234-612-161347",title:"dNetflix",author:{Hash:App.Agent.Hash,Name:App.Agent.String},description:"A Holochain Version of the your Netflix",thumbnail:"/imp5.jpg"}}));
